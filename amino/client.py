...
class Client:
    ...
    def login(self, email: str, password: str):
        ...
        **Returns**
        ...
        response = post(f"{self.api}/g/s/auth/login", headers=self.headers.headers(data=data), data=data)
    ...
    def register(self, nickname: str, email: str, password: str):
        ...
        **Returns**
        ...
        response = post(f"{self.api}/g/s/auth/register", data=data, headers=self.headers.headers(data=data))
        if response.status_code != 200:
            return exceptions.CheckException(json.loads(response.text))
        else:
            return response.status_code
    ...
    def restore(self, email: str, password: str):
        ...
        **Returns**
        ...
        response = post(f"{self.api}/g/s/account/delete-request/cancel",
                        headers=self.headers.headers(data=data), data=data)
        if response.status_code != 200:
            return exceptions.CheckException(json.loads(response.text))
        else:
            return response.status_code
    ...
    def logout(self):
        ...
        **Returns**
        ...
        response = post(f"{self.api}/g/s/auth/logout", headers=self.headers.headers(data=data), data=data)
        if response.status_code != 200:
            return exceptions.CheckException(json.loads(response.text))
        else:
            self.authenticated = False
    ...
    def configure(self, age: int, gender: str):
        ...
        **Returns**
        ...
        response = post(f"{self.api}/g/s/persona/profile/basic", data=data,
    ...
    def verify(self, email: str, code: str):
        ...
        **Returns**
        ...
        response = post(f"{self.api}/g/s/auth/check-security-validation",
                        headers=self.headers.headers(data=data), data=data)
        if response.status_code != 200:
            return exceptions.CheckException(json.loads(response.text))
        else:
    ...
    def request_verify_code(self, email: str, resetPassword: bool = False):
        ...
        **Returns**
        ...
        response = post(f"{self.api}/g/s/auth/request-security-validation",
                        headers=self.headers.headers(data=data), data=data)
        if response.status_code != 200:
            return exceptions.CheckException(json.loads(response.text))
        else:
    ...
    def activate_account(self, email: str, code: str):
        ...
        **Returns**
        ...
        response = post(f"{self.api}/g/s/auth/activate-email", headers=self.headers.headers(data=data),
                        data=data)
        if response.status_code != 200:
            return exceptions.CheckException(json.loads(response.text))
        else:
    ...
    def delete_account(self, password: str):
        ...
        **Returns**
        ...
        response = post(f"{self.api}/g/s/account/delete-request", headers=self.headers.headers(data=data),
                        data=data, )
        if response.status_code != 200:
            return exceptions.CheckException(json.loads(response.text))
        else:
    ...
    def change_password(self, email: str, password: str, code: str):
        ...
        **Returns**
        ...
        response = post(f"{self.api}/g/s/auth/reset-password", headers=self.headers.headers(data=data),
                        data=data, )
        if response.status_code != 200:
            return exceptions.CheckException(json.loads(response.text))
        else:
    ...
    def check_device(self, deviceId: str):
        ...
        **Returns**
        ...
        response = post(f"{self.api}/g/s/device", headers=self.headers.headers(data=data), data=data)
        if response.status_code != 200:
            return exceptions.CheckException(json.loads(response.text))
        else:
    ...
    def upload_media(self, file: BinaryIO, fileType: str):
        ...
        **Returns**
        ...
        data = file.read()
        response = post(f"{self.api}/g/s/media/upload", data=data,
                        headers=self.headers.headers(content_type=t, data=data))
        if response.status_code != 200:
            return exceptions.CheckException(json.loads(response.text))
        else:
    ...
    def sub_clients(self, start: int = 0, size: int = 25):
        ...
        **Returns**
        ...
        response = get(f"{self.api}/g/s/community/joined?v=1&start={start}&size={size}",
    ...
    def get_user_info(self, userId: str):
        ...
        **Returns**
            ...
            - **Fail** : :meth:`Exceptions <amino.lib.util.exceptions>`
        """
        response = get(f"{self.api}/g/s/user-profile/{userId}", headers=self.headers.headers())
        if response.status_code != 200:
            return exceptions.CheckException(json.loads(response.text))
        else:
    ...
    def get_chat_threads(self, start: int = 0, size: int = 25):
        ...
        **Returns**
            ...
            - **Fail** : :meth:`Exceptions <amino.lib.util.exceptions>`
        """
        response = get(f"{self.api}/g/s/chat/thread?type=joined-me&start={start}&size={size}",
                       headers=self.headers.headers())
        if response.status_code != 200:
            return exceptions.CheckException(json.loads(response.text))
        else:
    ...
    def get_chat_thread(self, chatId: str):
        ...
        **Returns**
            ...
            - **Fail** : :meth:`Exceptions <amino.lib.util.exceptions>`
        """
        response = get(f"{self.api}/g/s/chat/thread/{chatId}", headers=self.headers.headers())
        if response.status_code != 200:
            return exceptions.CheckException(json.loads(response.text))
        else:
    ...
    def get_chat_users(self, chatId: str, start: int = 0, size: int = 25):
        response = get(f"{self.api}/g/s/chat/thread/{chatId}/member?start={start}&size={size}&type=default&cv=1.2",
                       headers=self.headers.headers())
        if response.status_code != 200:
            return exceptions.CheckException(json.loads(response.text))
        else:
    ...
    def join_chat(self, chatId: str):
        ...
        **Returns**
            ...
            - **Fail** : :meth:`Exceptions <amino.lib.util.exceptions>`
        """
        response = post(f"{self.api}/g/s/chat/thread/{chatId}/member/{self.userId}",
                        headers=self.headers.headers())
        if response.status_code != 200:
            return exceptions.CheckException(json.loads(response.text))
        else:
    ...
    def leave_chat(self, chatId: str):
        ...
        **Returns**
            ...
            - **Fail** : :meth:`Exceptions <amino.lib.util.exceptions>`
        """
        response = delete(f"{self.api}/g/s/chat/thread/{chatId}/member/{self.userId}",
                          headers=self.headers.headers())
        if response.status_code != 200:
            return exceptions.CheckException(json.loads(response.text))
        else:
    ...
    def start_chat(self, userId: [str, list], message: str, title: str = None, content: str = None,
        ...
        **Returns**
        ...
        response = post(f"{self.api}/g/s/chat/thread", data=data, headers=self.headers.headers(data=data))
        if response.status_code != 200:
            return exceptions.CheckException(json.loads(response.text))
        else:
            return response.status_code
    ...
    def invite_to_chat(self, userId: [str, list], chatId: str):
        ...
        **Returns**
        ...
        response = post(f"{self.api}/g/s/chat/thread/{chatId}/member/invite",
                        headers=self.headers.headers(data=data), data=data)
        if response.status_code != 200:
            return exceptions.CheckException(json.loads(response.text))
        else:
    ...
    def get_chat_messages(self, chatId: str, size: int = 25, pageToken: str = None):
        ...
        **Returns**
        ...
        response = get(url, headers=self.headers.headers())
        if response.status_code != 200:
            return exceptions.CheckException(json.loads(response.text))
        else:
    ...
    def get_message_info(self, chatId: str, messageId: str):
        ...
        **Returns**
            ...
            - **Fail** : :meth:`Exceptions <amino.lib.util.exceptions>`
        """
        response = get(f"{self.api}/g/s/chat/thread/{chatId}/message/{messageId}",
                       headers=self.headers.headers())
        if response.status_code != 200:
            return exceptions.CheckException(json.loads(response.text))
        else:
    ...
    def search_community(self, aminoId: str):
        ...
        **Returns**
            ...
            - **Fail** : :meth:`Exceptions <amino.lib.util.exceptions>`
        """
        response = get(f"{self.api}/g/s/search/amino-id-and-link?q={aminoId}",
                       headers=self.headers.headers())
        if response.status_code != 200:
            return exceptions.CheckException(json.loads(response.text))
        else:
    ...
    def get_user_following(self, userId: str, start: int = 0, size: int = 25):
        ...
        **Returns**
            ...
            - **Fail** : :meth:`Exceptions <amino.lib.util.exceptions>`
        """
        response = get(f"{self.api}/g/s/user-profile/{userId}/joined?start={start}&size={size}",
                       headers=self.headers.headers())
        if response.status_code != 200:
            return exceptions.CheckException(json.loads(response.text))
        else:
    ...
    def get_user_followers(self, userId: str, start: int = 0, size: int = 25):
        ...
        **Returns**
            ...
            - **Fail** : :meth:`Exceptions <amino.lib.util.exceptions>`
        """
        response = get(f"{self.api}/g/s/user-profile/{userId}/member?start={start}&size={size}",
                       headers=self.headers.headers())
        if response.status_code != 200:
            return exceptions.CheckException(json.loads(response.text))
        else:
    ...
    def get_user_visitors(self, userId: str, start: int = 0, size: int = 25):
        ...
        **Returns**
            ...
            - **Fail** : :meth:`Exceptions <amino.lib.util.exceptions>`
        """
        response = get(f"{self.api}/g/s/user-profile/{userId}/visitors?start={start}&size={size}",
                       headers=self.headers.headers())
        if response.status_code != 200:
            return exceptions.CheckException(json.loads(response.text))
        else:
    ...
    def get_blocked_users(self, start: int = 0, size: int = 25):
        ...
        **Returns**
            ...
            - **Fail** : :meth:`Exceptions <amino.lib.util.exceptions>`
        """
        response = get(f"{self.api}/g/s/block?start={start}&size={size}", headers=self.headers.headers(),
                       )
        if response.status_code != 200:
            return exceptions.CheckException(json.loads(response.text))
        else:
    ...
    def get_blog_info(self, blogId: str = None, wikiId: str = None, quizId: str = None, fileId: str = None):
        if blogId or quizId:
            ...
            response = get(f"{self.api}/g/s/blog/{blogId}", headers=self.headers.headers())
            if response.status_code != 200:
                return exceptions.CheckException(json.loads(response.text))
            else:
            ...
            response = get(f"{self.api}/g/s/item/{wikiId}", headers=self.headers.headers())
            if response.status_code != 200:
                return exceptions.CheckException(json.loads(response.text))
            else:
            ...
            response = get(f"{self.api}/g/s/shared-folder/files/{fileId}", headers=self.headers.headers())
            if response.status_code != 200:
                return exceptions.CheckException(json.loads(response.text))
            else:
    ...
    def get_blog_comments(self, blogId: str = None, wikiId: str = None, quizId: str = None, fileId: str = None,
        ...
        if blogId or quizId:
            if quizId is not None: blogId = quizId
            response = get(f"{self.api}/g/s/blog/{blogId}/comment?sort={sorting}&start={start}&size={size}",
                           headers=self.headers.headers())
        elif wikiId:
            response = get(f"{self.api}/g/s/item/{wikiId}/comment?sort={sorting}&start={start}&size={size}",
                           headers=self.headers.headers())
        elif fileId:
            response = get(
    ...
    def get_blocker_users(self, start: int = 0, size: int = 25):
        ...
        **Returns**
            ...
            - **Fail** : :meth:`Exceptions <amino.lib.util.exceptions>`
        """
        response = get(f"{self.api}/g/s/block/full-list?start={start}&size={size}",
                       headers=self.headers.headers())
        if response.status_code != 200:
            return exceptions.CheckException(json.loads(response.text))
        else:
    ...
    def flag(self, reason: str, flagType: int, userId: str = None, blogId: str = None, wikiId: str = None,
        ...
        **Returns**
        ...
        data = json.dumps(data)
        response = post(f"{self.api}/g/s/{flg}", data=data, headers=self.headers.headers(data=data))
        if response.status_code != 200:
            return exceptions.CheckException(json.loads(response.text))
        else:
            return response.status_code
    ...
    def send_message(self, chatId: str, message: str = None, messageType: int = 0, file: BinaryIO = None,
        ...
        **Returns**
        ...
        data = json.dumps(data)
        response = post(f"{self.api}/g/s/chat/thread/{chatId}/message",
                        headers=self.headers.headers(data=data), data=data)
        if response.status_code != 200:
            return exceptions.CheckException(json.loads(response.text))
        else:
    ...
    def delete_message(self, chatId: str, messageId: str, asStaff: bool = False, reason: str = None):
        ...
        **Returns**
        ...
        data = json.dumps(data)
        if not asStaff:
            response = delete(f"{self.api}/g/s/chat/thread/{chatId}/message/{messageId}",
                                       headers=self.headers.headers(),
                                       )
        else:
            response = post(f"{self.api}/g/s/chat/thread/{chatId}/message/{messageId}/admin",
                            headers=self.headers.headers(data=data), data=data, )
        if response.status_code != 200:
            return exceptions.CheckException(json.loads(response.text))
        else:
    ...
    def mark_as_read(self, chatId: str, messageId: str):
        ...
        **Returns**
        ...
        response = post(f"{self.api}/g/s/chat/thread/{chatId}/mark-as-read", headers=self.headers.headers(),
                        data=data, )
        if response.status_code != 200:
            return exceptions.CheckException(json.loads(response.text))
        else:
        ...
        **Returns**
        ...
        if doNotDisturb is not None:
            if doNotDisturb:
                ...
                response = post(f"{self.api}/g/s/chat/thread/{chatId}/member/{self.userId}/alert", data=data,
                                headers=self.headers.headers(data=data),
                                )
                if response.status_code != 200:
        ...
        if pinChat is not None:
            if pinChat:
                response = post(f"{self.api}/g/s/chat/thread/{chatId}/pin", data=data,
                                headers=self.headers.headers(),
                                )
                if response.status_code != 200:
                    res.append(exceptions.CheckException(json.loads(response.text)))
            ...
            if not pinChat:
                response = post(f"{self.api}/g/s/chat/thread/{chatId}/unpin", data=data,
                                headers=self.headers.headers(),
                                )
                if response.status_code != 200:
                    res.append(exceptions.CheckException(json.loads(response.text)))
        ...
        if backgroundImage is not None:
            ...
            response = post(f"{self.api}/g/s/chat/thread/{chatId}/member/{self.userId}/background", data=data,
                            headers=self.headers.headers(data=data), )
            if response.status_code != 200:
                res.append(exceptions.CheckException(json.loads(response.text)))
            else:
        ...
        if coHosts is not None:
            ...
            response = post(f"{self.api}/g/s/chat/thread/{chatId}/co-host", data=data,
                            headers=self.headers.headers(data=data), )
            if response.status_code != 200:
                res.append(exceptions.CheckException(json.loads(response.text)))
            else:
        ...
        if canInvite is not None:
            if canInvite:
                response = post(f"{self.api}/g/s/chat/thread/{chatId}/members-can-invite/enable", data=data,
                                headers=self.headers.headers(data=data),
                                )
                if response.status_code != 200:
                    res.append(exceptions.CheckException(json.loads(response.text)))
            ...
            if not canInvite:
                response = post(f"{self.api}/g/s/chat/thread/{chatId}/members-can-invite/disable", data=data,
                                headers=self.headers.headers(data=data),
                                )
                if response.status_code != 200:
                    res.append(exceptions.CheckException(json.loads(response.text)))
        ...
        if canTip is not None:
            if canTip:
                response = post(f"{self.api}/g/s/chat/thread/{chatId}/tipping-perm-status/enable", data=data,
                                headers=self.headers.headers(data=data),
                                )
                if response.status_code != 200:
                    res.append(exceptions.CheckException(json.loads(response.text)))
            ...
            if not canTip:
                response = post(f"{self.api}/g/s/chat/thread/{chatId}/tipping-perm-status/disable", data=data,
                                headers=self.headers.headers(data=data),
                                )
                if response.status_code != 200:
                    res.append(exceptions.CheckException(json.loads(response.text)))
        ...
        data = json.dumps(data)
        response = post(f"{self.api}/g/s/chat/thread/{chatId}", headers=self.headers.headers(data=data),
                        data=data, )
        if response.status_code != 200:
            res.append(exceptions.CheckException(json.loads(response.text)))
        else:
    ...
    def visit(self, userId: str):
        ...
        **Returns**
            ...
            - **Fail** : :meth:`Exceptions <amino.lib.util.exceptions>`
        """
        response = get(f"{self.api}/g/s/user-profile/{userId}?action=visit", headers=self.headers.headers(),
                       )
        if response.status_code != 200:
            return exceptions.CheckException(json.loads(response.text))
        else:
    ...
    def send_coins(self, coins: int, blogId: str = None, chatId: str = None, objectId: str = None,
        ...
        data = json.dumps(data)
        response = post(url, headers=self.headers.headers(data=data), data=data)
        if response.status_code != 200:
            return exceptions.CheckException(json.loads(response.text))
        else:
            return response.status_code
    ...
    def follow(self, userId: [str, list]):
        ...
        **Returns**
        ...
        """
        if isinstance(userId, str):
            response = post(f"{self.api}/g/s/user-profile/{userId}/member", headers=self.headers.headers())

        elif isinstance(userId, list):
            data = json.dumps({"targetUidList": userId, "timestamp": int(timestamp() * 1000)})
            response = post(f"{self.api}/g/s/user-profile/{self.userId}/joined",
                            headers=self.headers.headers(data=data), data=data, )
    ...
    def unfollow(self, userId: str):
        ...
        **Returns**
            ...
            - **Fail** : :meth:`Exceptions <amino.lib.util.exceptions>`
        """
        response = delete(f"{self.api}/g/s/user-profile/{userId}/member/{self.userId}",
                                   headers=self.headers.headers())
        if response.status_code != 200:
            return exceptions.CheckException(json.loads(response.text))
        else:
    ...
    def block(self, userId: str):
        ...
        **Returns**
            ...
            - **Fail** : :meth:`Exceptions <amino.lib.util.exceptions>`
        """
        response = post(f"{self.api}/g/s/block/{userId}", headers=self.headers.headers())
        if response.status_code != 200:
            return exceptions.CheckException(json.loads(response.text))
        else:
            return response.status_code
    ...
    def unblock(self, userId: str):
        ...
        **Returns**
            ...
            - **Fail** : :meth:`Exceptions <amino.lib.util.exceptions>`
        """
        response = delete(f"{self.api}/g/s/block/{userId}", headers=self.headers.headers())
        if response.status_code != 200:
            return exceptions.CheckException(json.loads(response.text))
        else:
            return response.status_code
    ...
    def join_community(self, comId: str, invitationId: str = None):
        ...
        **Returns**
        ...
        data = json.dumps(data)
        response = post(f"{self.api}/x{comId}/s/community/join", data=data,
                        headers=self.headers.headers(data=data))
        if response.status_code != 200:
            return exceptions.CheckException(json.loads(response.text))
        else:
    ...
    def request_join_community(self, comId: str, message: str = None):
        ...
        **Returns**
        ...
        response = post(f"{self.api}/x{comId}/s/community/membership-request", data=data,
                        headers=self.headers.headers(data=data))
        if response.status_code != 200:
            return exceptions.CheckException(json.loads(response.text))
        else:
    ...
    def leave_community(self, comId: str):
        ...
        **Returns**
            ...
            - **Fail** : :meth:`Exceptions <amino.lib.util.exceptions>`
        """
        response = post(f"{self.api}/x{comId}/s/community/leave", headers=self.headers.headers())
        if response.status_code != 200:
            return exceptions.CheckException(json.loads(response.text))
        else:
            return response.status_code
    ...
    def flag_community(self, comId: str, reason: str, flagType: int, isGuest: bool = False):
        ...
        **Returns**
        ...
        response = post(f"{self.api}/x{comId}/s/{flg}", data=data, headers=self.headers.headers(data=data))
        if response.status_code != 200:
            return exceptions.CheckException(json.loads(response.text))
        else:
            return response.status_code

    def edit_profile(self, nickname: str = None, content: str = None, icon: str = None, backgroundColor: str = None,
                     backgroundImage: str = None, defaultBubbleId: str = None):
        """
        ...
        **Returns**
        ...
        data = json.dumps(data)
        response = post(f"{self.api}/g/s/user-profile/{self.userId}",
                        headers=self.headers.headers(data=data), data=data)
        if response.status_code != 200:
            return exceptions.CheckException(json.loads(response.text))
        else:
    ...
    def set_privacy_status(self, isAnonymous: bool = False, getNotifications: bool = False):
        ...
        **Returns**
        ...
        data = json.dumps(data)
        response = post(f"{self.api}/g/s/account/visit-settings", headers=self.headers.headers(data=data),
                        data=data, )
        if response.status_code != 200:
            return exceptions.CheckException(json.loads(response.text))
        else:
    ...
    def set_amino_id(self, aminoId: str):
        ...
        **Returns**
        ...
        response = post(f"{self.api}/g/s/account/change-amino-id", headers=self.headers.headers(data=data),
                        data=data, )
        if response.status_code != 200:
            return exceptions.CheckException(json.loads(response.text))
        else:
    ...
    def get_linked_communities(self, userId: str):
        ...
        **Returns**
            ...
            - **Fail** : :meth:`Exceptions <amino.lib.util.exceptions>`
        """
        response = get(f"{self.api}/g/s/user-profile/{userId}/linked-community",
                       headers=self.headers.headers())
        if response.status_code != 200:
            return exceptions.CheckException(json.loads(response.text))
        else:
    ...
    def reorder_linked_communities(self, comIds: list):
        ...
        **Returns**
        ...
        response = post(f"{self.api}/g/s/user-profile/{self.userId}/linked-community/reorder",
                        headers=self.headers.headers(data=data), data=data)
        if response.status_code != 200:
            return exceptions.CheckException(json.loads(response.text))
        else:
    ...
    def add_linked_community(self, comId: str):
        ...
        **Returns**
            ...
            - **Fail** : :meth:`Exceptions <amino.lib.util.exceptions>`
        """
        response = post(f"{self.api}/g/s/user-profile/{self.userId}/linked-community/{comId}",
                        headers=self.headers.headers())
        if response.status_code != 200:
            return exceptions.CheckException(json.loads(response.text))
        else:
    ...
    def remove_linked_community(self, comId: str):
        ...
        **Returns**
            ...
            - **Fail** : :meth:`Exceptions <amino.lib.util.exceptions>`
        """
        response = delete(f"{self.api}/g/s/user-profile/{self.userId}/linked-community/{comId}",
                                   headers=self.headers.headers())
        if response.status_code != 200:
            return exceptions.CheckException(json.loads(response.text))
        else:
    ...
    def comment(self, message: str, userId: str = None, blogId: str = None, wikiId: str = None, replyTo: str = None):
        ...
        **Returns**
        ...
        if userId:
            ...
            data = json.dumps(data)
            response = post(f"{self.api}/g/s/user-profile/{userId}/g-comment",
                            headers=self.headers.headers(data=data), data=data, )

        elif blogId:
            data["eventSource"] = "PostDetailView"
            data = json.dumps(data)
            response = post(f"{self.api}/g/s/blog/{blogId}/g-comment",
                            headers=self.headers.headers(data=data), data=data, )

        elif wikiId:
            data["eventSource"] = "PostDetailView"
            data = json.dumps(data)
            response = post(f"{self.api}/g/s/item/{wikiId}/g-comment",
                            headers=self.headers.headers(data=data), data=data, )
    ...
    def delete_comment(self, commentId: str, userId: str = None, blogId: str = None, wikiId: str = None):
        ...
        **Returns**
        ...
        """
        if userId:
            response = delete(f"{self.api}/g/s/user-profile/{userId}/g-comment/{commentId}",
                                       headers=self.headers.headers(),
                                       )
        elif blogId:
            response = delete(f"{self.api}/g/s/blog/{blogId}/g-comment/{commentId}",
                                       headers=self.headers.headers(),
                                       )
        elif wikiId:
            response = delete(f"{self.api}/g/s/item/{wikiId}/g-comment/{commentId}",
                                       headers=self.headers.headers(),
                                       )
        else:
            raise exceptions.SpecifyType
        ...
        **Returns**
        ...
        if blogId:
            if isinstance(blogId, str):
                data["eventSource"] = "UserProfileView"
                data = json.dumps(data)
                response = post(f"{self.api}/g/s/blog/{blogId}/g-vote?cv=1.2",
                                headers=self.headers.headers(data=data), data=data,
                                )
                ...
                data = json.dumps(data)
                response = post(f"{self.api}/g/s/feed/g-vote", headers=self.headers.headers(data=data),
                                data=data, )
            ...
            data["eventSource"] = "PostDetailView"
            data = json.dumps(data)
            response = post(f"{self.api}/g/s/item/{wikiId}/g-vote?cv=1.2",
                            headers=self.headers.headers(data=data), data=data, )
    ...
    def unlike_blog(self, blogId: str = None, wikiId: str = None):
        ...
        **Returns**
        ...
        """
        if blogId:
            response = delete(f"{self.api}/g/s/blog/{blogId}/g-vote?eventSource=UserProfileView",
                                       headers=self.headers.headers(),
                                       )
        elif wikiId:
            response = delete(f"{self.api}/g/s/item/{wikiId}/g-vote?eventSource=PostDetailView",
                                       headers=self.headers.headers(),
                                       )
        else:
            raise exceptions.SpecifyType
    ...
    def like_comment(self, commentId: str, userId: str = None, blogId: str = None, wikiId: str = None):
        ...
        **Returns**
        ...
        if userId:
            data["eventSource"] = "UserProfileView"
            data = json.dumps(data)
            response = post(f"{self.api}/g/s/user-profile/{userId}/comment/{commentId}/g-vote?cv=1.2&value=1",
                            headers=self.headers.headers(data=data), data=data, )

        elif blogId:
            data["eventSource"] = "PostDetailView"
            data = json.dumps(data)
            response = post(f"{self.api}/g/s/blog/{blogId}/comment/{commentId}/g-vote?cv=1.2&value=1",
                            headers=self.headers.headers(data=data), data=data, )

        elif wikiId:
            data["eventSource"] = "PostDetailView"
            data = json.dumps(data)
            response = post(f"{self.api}/g/s/item/{wikiId}/comment/{commentId}/g-vote?cv=1.2&value=1",
                            headers=self.headers.headers(data=data), data=data, )
    ...
    def get_membership_info(self):
        ...
        **Returns**
            ...
            - **Fail** : :meth:`Exceptions <amino.lib.util.exceptions>`
        """
        response = get(f"{self.api}/g/s/membership?force=true", headers=self.headers.headers(),
                       )
        if response.status_code != 200:
            return exceptions.CheckException(json.loads(response.text))
        else:
    ...
    def get_ta_announcements(self, language: str = "en", start: int = 0, size: int = 25):
        ...
        **Returns**
        ...
        response = get(f"{self.api}/g/s/announcement?language={language}&start={start}&size={size}",
                       headers=self.headers.headers())
        if response.status_code != 200:
            return exceptions.CheckException(json.loads(response.text))
        else:
    ...
    def get_wallet_info(self):
        ...
        **Returns**
            ...
            - **Fail** : :meth:`Exceptions <amino.lib.util.exceptions>`
        """
        response = get(f"{self.api}/g/s/wallet", headers=self.headers.headers(),
                       )
        if response.status_code != 200:
            return exceptions.CheckException(json.loads(response.text))
        else:
    ...
    def get_wallet_history(self, start: int = 0, size: int = 25):
        ...
        **Returns**
            ...
            - **Fail** : :meth:`Exceptions <amino.lib.util.exceptions>`
        """
        response = get(f"{self.api}/g/s/wallet/coin/history?start={start}&size={size}",
                       headers=self.headers.headers())
        if response.status_code != 200:
            return exceptions.CheckException(json.loads(response.text))
        else:
    ...
    def get_from_deviceid(self, deviceId: str):
        ...
        **Returns**
            ...
            - **Fail** : :meth:`Exceptions <amino.lib.util.exceptions>`
        """
        response = get(f"{self.api}/g/s/auid?deviceId={deviceId}")
        if response.status_code != 200:
            return exceptions.CheckException(json.loads(response.text))
        else:
    ...
    def get_from_code(self, code: str):
        ...
        **Returns**
            ...
            - **Fail** : :meth:`Exceptions <amino.lib.util.exceptions>`
        """
        response = get(f"{self.api}/g/s/link-resolution?q={code}", headers=self.headers.headers(),
                       )
        if response.status_code != 200:
            return exceptions.CheckException(json.loads(response.text))
        else:
    ...
    def get_from_id(self, objectId: str, objectType: int, comId: str = None):
        ...
        **Returns**
        ...
        if comId:
            response = post(f"{self.api}/g/s-x{comId}/link-resolution",
                            headers=self.headers.headers(data=data), data=data, )
        else:
            response = post(f"{self.api}/g/s/link-resolution", headers=self.headers.headers(data=data),
                            data=data, )
        if response.status_code != 200:
            return exceptions.CheckException(json.loads(response.text))
        else:
    ...
    def get_supported_languages(self):
        ...
        **Returns**
            ...
            - **Fail** : :meth:`Exceptions <amino.lib.util.exceptions>`
        """
        response = get(f"{self.api}/g/s/community-collection/supported-languages?start=0&size=100",
                       headers=self.headers.headers())
        if response.status_code != 200:
            return exceptions.CheckException(json.loads(response.text))
        else:
    ...
    def claim_new_user_coupon(self):
        ...
        **Returns**
            ...
            - **Fail** : :meth:`Exceptions <amino.lib.util.exceptions>`
        """
        response = post(f"{self.api}/g/s/coupon/new-user-coupon/claim", headers=self.headers.headers())
        if response.status_code != 200:
            return exceptions.CheckException(json.loads(response.text))
        else:
            return response.status_code
    ...
    def get_subscriptions(self, start: int = 0, size: int = 25):
        ...
        **Returns**
            ...
            - **Fail** : :meth:`Exceptions <amino.lib.util.exceptions>`
        """
        response = get(f"{self.api}/g/s/store/subscription?objectType=122&start={start}&size={size}",
                       headers=self.headers.headers())
        if response.status_code != 200:
            return exceptions.CheckException(json.loads(response.text))
        else:
    ...
    def get_all_users(self, start: int = 0, size: int = 25):
        ...
        **Returns**
            ...
            - **Fail** : :meth:`Exceptions <amino.lib.util.exceptions>`
        """
        response = get(f"{self.api}/g/s/user-profile?type=recent&start={start}&size={size}",
                       headers=self.headers.headers())
        if response.status_code != 200:
            return exceptions.CheckException(json.loads(response.text))
        else:
    ...
    def accept_host(self, chatId: str, requestId: str):
        ...
        response = post(f"{self.api}/g/s/chat/thread/{chatId}/transfer-organizer/{requestId}/accept",
                        headers=self.headers.headers(data=data), data=data)
        if response.status_code != 200:
            return exceptions.CheckException(json.loads(response.text))
        else:

...
class SubClient:
    def __init__(self, comId: str, client):
        self.client = client
        self.comId = comId
    ...
    def generate_invite_code(self, duration: int = 0, force: bool = True):
        ...
        response = post(f"{self.client.api}/g/s-x{self.comId}/community/invitation",
    ...
    def post_blog(self, title: str, content: str, imageList: list = None, categoriesList: list = None,
                  backgroundColor: str = None, fansOnly: bool = False, extensions: dict = None):
        mediaList = []

        for image in imageList:
            mediaList.append([100, self.client.upload_media(image, "image"), None])
        ...
        response = post(f"{self.client.api}/x{self.comId}/s/blog", headers=self.client.headers.headers(data=data),
                        data=data, )
        if response.status_code != 200:
            return exceptions.CheckException(json.loads(response.text))
        else:
    ...
    def post_wiki(self, title: str, content: str, icon: str = None, imageList: list = None, keywords: str = None,
        ...
        if backgroundColor: data["extensions"] = {"style": {"backgroundColor": backgroundColor}}
        data = json.dumps(data)
        response = post(f"{self.client.api}/x{self.comId}/s/item", headers=self.client.headers.headers(data=data),
                        data=data, )
        if response.status_code != 200:
            return exceptions.CheckException(json.loads(response.text))
        else:
    ...
    def edit_blog(self, blogId: str, title: str = None, content: str = None, imageList: list = None,
        ...
        if categoriesList: data["taggedBlogCategoryIdList"] = categoriesList
        data = json.dumps(data)
        response = post(f"{self.client.api}/x{self.comId}/s/blog/{blogId}",
                        headers=self.client.headers.headers(data=data), data=data)
        if response.status_code != 200:
            return exceptions.CheckException(json.loads(response.text))
        else:
    ...
    def check_in(self, tz: str = -timezone // 1000):
        ...
        response = post(f"{self.client.api}/x{self.comId}/s/check-in",
    ...
    def repair_check_in(self, method: int = 0):
        ...
        data = json.dumps(data)
        response = post(f"{self.client.api}/x{self.comId}/s/check-in/repair",
                        headers=self.client.headers.headers(data=data), data=data)
        if response.status_code != 200:
            return exceptions.CheckException(json.loads(response.text))
        else:
    ...
    def lottery(self, tz: str = -timezone // 1000):
        ...
        response = post(f"{self.client.api}/x{self.comId}/s/check-in/lottery",
                        headers=self.client.headers.headers(data=data), data=data)
        if response.status_code != 200:
            return exceptions.CheckException(json.loads(response.text))
        else:
    ...
    def edit_profile(self, nickname: str = None, content: str = None, icon: str = None,
                     chatRequestPrivilege: str = None, mediaList: list = None, backgroundImage: str = None,
                     backgroundColor: str = None, titles: list = None, defaultBubbleId: str = None):
        data = {"timestamp": int(timestamp() * 1000)}
        ...
        data = json.dumps(data)
        response = post(f"{self.client.api}/x{self.comId}/s/user-profile/{self.profile.userId}",
                        headers=self.client.headers.headers(data=data), data=data)
        if response.status_code != 200:
            return exceptions.CheckException(json.loads(response.text))
        else:
    ...
    def vote_poll(self, blogId: str, optionId: str):
        ...
        response = post(f"{self.client.api}/x{self.comId}/s/blog/{blogId}/poll/option/{optionId}/vote",
                        headers=self.client.headers.headers(data=data), data=data)
        if response.status_code != 200:
            return exceptions.CheckException(json.loads(response.text))
        else:
    ...
    def like_comment(self, commentId: str, userId: str = None, blogId: str = None, wikiId: str = None):
        ...
        if userId:
            ...
            data = json.dumps(data)
            response = post(
                f"{self.client.api}/x{self.comId}/s/user-profile/{userId}/comment/{commentId}/vote?cv=1.2&value=1",
                headers=self.client.headers.headers(data=data), data=data,
            )
            ...
            data = json.dumps(data)
            response = post(
                f"{self.client.api}/x{self.comId}/s/blog/{blogId}/comment/{commentId}/vote?cv=1.2&value=1",
                headers=self.client.headers.headers(data=data), data=data,
            )
            ...
            data = json.dumps(data)
            response = post(
                f"{self.client.api}/x{self.comId}/s/item/{wikiId}/comment/{commentId}/g-vote?cv=1.2&value=1",
                headers=self.client.headers.headers(data=data), data=data,
            )
    ...
    def upvote_comment(self, blogId: str, commentId: str):
        ...
        response = post(f"{self.client.api}/x{self.comId}/s/blog/{blogId}/comment/{commentId}/vote?cv=1.2&value=1",
                        headers=self.client.headers.headers(data=data), data=data)
        if response.status_code != 200:
            return exceptions.CheckException(json.loads(response.text))
        else:
    ...
    def reply_wall(self, userId: str, commentId: str, message: str):
        ...
        response = post(f"{self.client.api}/x{self.comId}/s/user-profile/{userId}/comment",
                        headers=self.client.headers.headers(data=data), data=data)
        if response.status_code != 200:
            return exceptions.CheckException(json.loads(response.text))
        else:
    ...
    def send_active_obj(self, startTime: int, endTime: int, optInAdsFlags: int = 2147483647,
        ...
        response = post(f"{self.client.api}/x{self.comId}/s/community/stats/user-active-time",
                        headers=self.client.headers.headers(data=data), data=data)
        if response.status_code != 200:
            return exceptions.CheckException(json.loads(response.text))
        else:
    ...
    def activity_status(self, status: str):
        ...
        response = post(f"{self.client.api}/x{self.comId}/s/user-profile/{self.profile.userId}/online-status",
                        headers=self.client.headers.headers(data=data), data=data)
        if response.status_code != 200:
            return exceptions.CheckException(json.loads(response.text))
        else:
    ...
    # TODO : Finish this
    def watch_ad(self):
        response = post(f"{self.client.api}/g/s/wallet/ads/video/start", headers=self.client.headers.headers())
        if response.status_code != 200:
            return exceptions.CheckException(json.loads(response.text))
        else:
            return response.status_code
    ...
    def check_notifications(self):
        response = post(f"{self.client.api}/x{self.comId}/s/notification/checked",
                        headers=self.client.headers.headers())
        if response.status_code != 200:
            return exceptions.CheckException(json.loads(response.text))
        else:
    ...
    def start_chat(self, userId: [str, list], message: str, title: str = None, content: str = None,
        ...
        response = post(f"{self.client.api}/x{self.comId}/s/chat/thread", data=data,
                        headers=self.client.headers.headers(data=data))
        if response.status_code != 200:
            return exceptions.CheckException(json.loads(response.text))
        else:
    ...
    def invite_to_chat(self, userId: [str, list], chatId: str):
        ...
        response = post(f"{self.client.api}/x{self.comId}/s/chat/thread/{chatId}/member/invite",
                        headers=self.client.headers.headers(data=data), data=data)
        if response.status_code != 200:
            return exceptions.CheckException(json.loads(response.text))
        else:
    ...
    def add_to_favorites(self, userId: str):
        response = post(f"{self.client.api}/x{self.comId}/s/user-group/quick-access/{userId}",
                        headers=self.client.headers.headers())
        if response.status_code != 200:
            return exceptions.CheckException(json.loads(response.text))
        else:
    ...
    def send_coins(self, coins: int, blogId: str = None, chatId: str = None, objectId: str = None,
        ...
        if blogId is not None: url = f"{self.client.api}/x{self.comId}/s/blog/{blogId}/tipping"
        if chatId is not None: url = f"{self.client.api}/x{self.comId}/s/chat/thread/{chatId}/tipping"
        ...
        data = json.dumps(data)
        response = post(url, headers=self.client.headers.headers(data=data), data=data)
        if response.status_code != 200:
            return exceptions.CheckException(json.loads(response.text))
        else:
            return response.status_code
    ...
    def thank_tip(self, chatId: str, userId: str):
        response = post(f"{self.client.api}/x{self.comId}/s/chat/thread/{chatId}/tipping/tipped-users/{userId}/thank",
                        headers=self.client.headers.headers())
        if response.status_code != 200:
            return exceptions.CheckException(json.loads(response.text))
        else:
    ...
    def block(self, userId: str):
        ...
        **Returns**
            ...
            - **Fail** : :meth:`Exceptions <amino.lib.util.exceptions>`
        """
        response = post(f"{self.client.api}/x{self.comId}/s/block/{userId}", headers=self.client.headers.headers())
        if response.status_code != 200:
            return exceptions.CheckException(json.loads(response.text))
        else:
            return response.status_code
    ...
    def flag(self, reason: str, flagType: int, userId: str = None, blogId: str = None, wikiId: str = None,
        ...
        **Returns**
        ...
        data = json.dumps(data)
        response = post(f"{self.client.api}/x{self.comId}/s/{flg}", data=data,
                        headers=self.client.headers.headers(data=data))
        if response.status_code != 200:
            return exceptions.CheckException(json.loads(response.text))
        else:
    ...
    def send_message(self, message: str = None, messageType: int = 0, chatId: str = None, file: BinaryIO = None,
        ...
        **Returns**
        ...
        data = json.dumps(data)
        response = post(f"{self.client.api}/x{self.comId}/s/chat/thread/{chatId}/message",
                        headers=self.client.headers.headers(data=data), data=data)
        if response.status_code != 200:
            return exceptions.CheckException(json.loads(response.text))
        else:
    ...
    def mark_as_read(self, chatId: str, messageId: str):
        ...
        **Returns**
        ...
        response = post(f"{self.client.api}/x{self.comId}/s/chat/thread/{chatId}/mark-as-read",
                        headers=self.client.headers.headers(data=data), data=data)
        if response.status_code != 200:
            return exceptions.CheckException(json.loads(response.text))
        else:
        ...
        **Returns**
        ...
        if doNotDisturb is not None:
            if doNotDisturb:
                ...
                response = post(
                    f"{self.client.api}/x{self.comId}/s/chat/thread/{chatId}/member/{self.profile.userId}/alert",
                    data=data,
                    headers=self.client.headers.headers(data=data), )
                if response.status_code != 200:
        ...
        if backgroundImage is not None:
            ...
            response = post(
                f"{self.client.api}/x{self.comId}/s/chat/thread/{chatId}/member/{self.profile.userId}/background",
                data=data,
                headers=self.client.headers.headers(data=data), )
            if response.status_code != 200:
                res.append(exceptions.CheckException(json.loads(response.text)))
        ...
        data = json.dumps(data)
        response = post(f"{self.client.api}/x{self.comId}/s/chat/thread/{chatId}",
                        headers=self.client.headers.headers(data=data), data=data)
        if response.status_code != 200:
            res.append(exceptions.CheckException(json.loads(response.text)))
        else:
    ...
    def transfer_host(self, chatId: str, userIds: list):
        ...
        response = post(f"{self.client.api}/x{self.comId}/s/chat/thread/{chatId}/transfer-organizer",
                        headers=self.client.headers.headers(data=data), data=data)
        if response.status_code != 200:
            return exceptions.CheckException(json.loads(response.text))
        else:
    ...
    def accept_host(self, chatId: str, requestId: str):
        ...
        response = post(
            f"{self.client.api}/x{self.comId}/s/chat/thread/{chatId}/transfer-organizer/{requestId}/accept",
            headers=self.client.headers.headers(data=data), data=data,
        )
        if response.status_code != 200:
            return exceptions.CheckException(json.loads(response.text))
    ...
    def join_chat(self, chatId: str):
        ...
        **Returns**
            ...
            - **Fail** : :meth:`Exceptions <amino.lib.util.exceptions>`
        """
        response = post(f"{self.client.api}/x{self.comId}/s/chat/thread/{chatId}/member/{self.profile.userId}",
                        headers=self.client.headers.headers())
        if response.status_code != 200:
            return exceptions.CheckException(json.loads(response.text))
        else:
    ...
    def subscribe(self, userId: str, autoRenew: str = False, transactionId: str = None):
        ...
        response = post(f"{self.client.api}/x{self.comId}/s/influencer/{userId}/subscribe",
                        headers=self.client.headers.headers(data=data), data=data)
        if response.status_code != 200:
            return exceptions.CheckException(json.loads(response.text))
        else:
    ...
    def promotion(self, noticeId: str, type: str = "accept"):
        response = post(f"{self.client.api}/x{self.comId}/s/notice/{noticeId}/{type}",
                        headers=self.client.headers.headers())
        if response.status_code != 200:
            return exceptions.CheckException(json.loads(response.text))
        else:
    ...
    def play_quiz_raw(self, quizId: str, quizAnswerList: list, quizMode: int = 0):
        ...
        response = post(f"{self.client.api}/x{self.comId}/s/blog/{quizId}/quiz/result",
                        headers=self.client.headers.headers(data=data), data=data)
        if response.status_code != 200:
            return exceptions.CheckException(json.loads(response.text))
        else:
    ...
    def vc_permission(self, chatId: str, permission: int):
        ...
        response = post(f"{self.client.api}/x{self.comId}/s/chat/thread/{chatId}/vvchat-permission",
                        headers=self.client.headers.headers(data=data), data=data)
        if response.status_code != 200:
            return exceptions.CheckException(json.loads(response.text))
        else:
    ...
    def claim_vc_reputation(self, chatId: str):
        response = post(f"{self.client.api}/x{self.comId}/s/chat/thread/{chatId}/avchat-reputation",
                        headers=self.client.headers.headers())
        if response.status_code != 200:
            return exceptions.CheckException(json.loads(response.text))
        else:
    ...
    def warn(self, userId: str, reason: str = None):
        ...
        response = post(f"{self.client.api}/x{self.comId}/s/notice", headers=self.client.headers.headers(data=data),
                        data=data, )
        if response.status_code != 200:
            return exceptions.CheckException(json.loads(response.text))
        else:
    ...
    def ban(self, userId: str, reason: str, banType: int = None):
        ...
        response = post(f"{self.client.api}/x{self.comId}/s/user-profile/{userId}/ban",
                        headers=self.client.headers.headers(data=data), data=data)
        if response.status_code != 200:
            return exceptions.CheckException(json.loads(response.text))
        else:
    ...
    def unban(self, userId: str, reason: str):
        ...
        response = post(f"{self.client.api}/x{self.comId}/s/user-profile/{userId}/unban",
                        headers=self.client.headers.headers(data=data), data=data)
        if response.status_code != 200:
            return exceptions.CheckException(json.loads(response.text))
        else:
    ...
    def reorder_featured_users(self, userIds: list):
        ...
        response = post(f"{self.client.api}/x{self.comId}/s/user-profile/featured/reorder",
                        headers=self.client.headers.headers(data=data), data=data)
        if response.status_code != 200:
            return exceptions.CheckException(json.loads(response.text))
        else:
    ...
    def purchase(self, objectId: str, objectType: int, aminoPlus: bool = True, autoRenew: bool = False):
        ...
        data = json.dumps(data)
        response = post(f"{self.client.api}/x{self.comId}/s/store/purchase",
                        headers=self.client.headers.headers(data=data), data=data)
        if response.status_code != 200:
            return exceptions.CheckException(json.loads(response.text))
        else:
    ...
    def apply_avatar_frame(self, avatarId: str, applyToAll: bool = True):
        ...
        **Returns**
        ...
        response = post(f"{self.client.api}/x{self.comId}/s/avatar-frame/apply",
                        headers=self.client.headers.headers(data=data), data=data)
        if response.status_code != 200:
            return exceptions.CheckException(json.loads(response.text))
        else:
    ...
    def add_poll_option(self, blogId: str, question: str):
        ...
        response = post(f"{self.client.api}/x{self.comId}/s/blog/{blogId}/poll/option",
                        headers=self.client.headers.headers(data=data), data=data)
        if response.status_code != 200:
            return exceptions.CheckException(json.loads(response.text))
        else:
    ...
    def create_wiki_category(self, title: str, parentCategoryId: str, content: str = None):
        ...
        response = post(f"{self.client.api}/x{self.comId}/s/item-category",
                        headers=self.client.headers.headers(data=data), data=data)
        if response.status_code != 200:
            return exceptions.CheckException(json.loads(response.text))
        else:
    ...
    def submit_to_wiki(self, wikiId: str, message: str):
        ...
        response = post(f"{self.client.api}/x{self.comId}/s/knowledge-base-request",
                        headers=self.client.headers.headers(data=data), data=data)
        if response.status_code != 200:
            return exceptions.CheckException(json.loads(response.text))
        else:
    ...
    def accept_wiki_request(self, requestId: str, destinationCategoryIdList: list):
        ...
        response = post(f"{self.client.api}/x{self.comId}/s/knowledge-base-request/{requestId}/approve",
                        headers=self.client.headers.headers(data=data), data=data)
        if response.status_code != 200:
            return exceptions.CheckException(json.loads(response.text))
        else:
    ...
    def reject_wiki_request(self, requestId: str):
        ...
        response = post(f"{self.client.api}/x{self.comId}/s/knowledge-base-request/{requestId}/reject",
                        headers=self.client.headers.headers(data=data), data=data)
        if response.status_code != 200:
            return exceptions.CheckException(json.loads(response.text))
        else:
